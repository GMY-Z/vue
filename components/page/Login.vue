        ...
        methods: {
            submitForm(formName) {
                ...
                self.$refs[formName].validate((valid) => {
                    if (valid) {                      
                        self.$http.post('/api/user/login',self.ruleForm)//JSON.stringify(self.ruleForm
                        .then((response) => {
                            ...
                            if(self.ruleForm.name.length == 19)
                            {
                                self.$router.push('/Cinfo');
                            }
                            else if(self.ruleForm.name == '00000001')
                            {
                                self.$router.push('/Abusiness');
                            }
                            else if(self.ruleForm.name.length == 8)
                            {
